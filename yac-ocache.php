...
function yac_ocache_render_dashboard_widget() {
	...
	<div style="display: flex; gap: 20px; align-items: center; flex-wrap: wrap;">
		...
		<div style="flex: 1; min-width: 220px; font-size: 13px; color: #50575e;">
			...
			<div style="display: flex; justify-content: space-between; padding: 3px 0;"><span><?php echo esc_html( 'Key slots used' ); ?></span><strong style="color: #1d2327;"><?php echo esc_html( yac_ocache_format_kmb( $keys_used ) . ' / ' . yac_ocache_format_kmb( $keys_total ) ); ?></strong></div>
